"""aidecast_18874 URL Configuration
...
admin.site.site_header = "aidecast"
admin.site.site_title = "aidecast Admin Portal"
admin.site.index_title = "aidecast Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="aidecast API",
        default_version="v1",
        description="API documentation for aidecast App",
    ),
    public=True,
